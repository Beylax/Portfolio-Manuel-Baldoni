            ...
            <div className="Home">
                <section className="position-relative mt-5 row g-0 align-items-center">
                    <div className="Social col-md-2 g-0">
                        ...
                        <a className="col-4 col-md-12" href="https://www.linkedin.com/manuel-baldoni-765342245" target="_blank" rel="noreferrer">
                            <img src={require("../Images/linkedin-logo.png")} alt="www.linkedin.com/in/manuel-baldoni-765342245"/>
                        </a>
                        <a className="col-4 col-md-12" href="https://www.instagram.com/_baldo._/" target="_blank" rel="noreferrer">
