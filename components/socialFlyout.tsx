    ...
    return (
        <>
            <div className="fixed left-4 top-1/2 translate-y-[-50%] hidden lg:flex flex-col gap-4 z-[10000]">
                <button className="w-[50px] h-[50px] p-2 flex items-center justify-center z-[10000] bg-gradient-to-r from-highlight to-highlight50 rounded-full z-[100000]" onClick={() => setIsVisible(true)}>
